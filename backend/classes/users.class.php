...
class UserLogin extends MySQL{
   ...
   public function user_exists($username){
       ...
       $this->Query("SELECT user_id FROM adm_usr_users WHERE username = '$uname'");
    ...
    public function blacklisted($username){
        ...
        $this->Query("SELECT status FROM adm_usr_users WHERE username = '$user'");
        $statRow = $this->Row();
    ...
    public function user_active($username){
        ...
        $this->Query("SELECT user_id FROM adm_usr_users WHERE username = '$user' AND status = 'active' ");
    ...
    public function user_id_from_username($username){
        ...
        $this->Query("SELECT user_id FROM adm_usr_users WHERE username = '$username'");
        $row = $this->Row();
        $id = $row->user_id;
        return $id;
    ...
    public function login($username, $password){
        ...
        $this->Query("SELECT user_id FROM adm_usr_users WHERE username = '$username' AND password = '$password' ");
