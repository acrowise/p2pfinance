						...
						<div class="span9">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-user"></i> Add A User</h4>
									<span class="tools">
									...
									<table class="table table-bordered table-advance">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><select name="fullname" id="fullname" style=" height:30px" class="form-inline">
                                                        <option disabled selected>--SELECT--</option>
                                                        <?php $uname = new MySQL; $uname->MoveFirst(); $uname->Query("SELECT * FROM staff_pdetail ORDER BY first_name ASC");
                                                        while(!$uname->EndOfSeek()){$urow = $uname->Row(); ?>
                                                            <option value="<?php echo $urow->empID .":".$urow->last_name.'+'.$urow->first_name; ?>">
                                                                <?php echo "$urow->first_name $urow->last_name";?>
                                                            </option>
                                                        <?php }?>
                                                    </select><br><p id="fname_error"></p></td>

                                            <td><h5>User Category:</h5></td>
                                            <td><select id="category" name="category" class="form-inline">
                                                    <?php while(!$getUserCat->EndOfSeek()){$crow = $getUserCat->Row(); ?>
